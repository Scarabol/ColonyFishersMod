...
default:
	rm -rf "/media/DATA/Steam/steamapps/common/Colony Survival/gamedata/savegames/kingdoms3"
	cp -r "/media/DATA/Steam/steamapps/common/Colony Survival/gamedata/savegames/kingdoms2" "/media/DATA/Steam/steamapps/common/Colony Survival/gamedata/savegames/kingdoms3"
